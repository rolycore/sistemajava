...
public final class Sistema extends javax.swing.JFrame {
    ...
    public void ListarCliente() {
     ...
     public void ListarAlumnos() {
        List<Alumnos> ListarAl = alum.ListarAlumnos();
        modelo = (DefaultTableModel) TableAlumno.getModel();
        Object[] ob = new Object[6];
        for (int i = 0; i < ListarAl.size(); i++) {
            ob[0] = ListarAl.get(i).getId();
            ob[1] = ListarAl.get(i).getNombre();
            ob[2] = ListarAl.get(i).getApellido();
            ob[3] = ListarAl.get(i).getCedula();
            ob[4] = ListarAl.get(i).getSexo();
            ob[5] = ListarAl.get(i).getGrado();
            modelo.addRow(ob);
        }
    ...
    private void initComponents() {
        ...
        btnAlumnos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Clientes.png"))); // NOI18N
        ...
        TableAlumno.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellido", "Cedula", "Sexo", "Grado"
            }
        ));
        TableAlumno.setMinimumSize(new java.awt.Dimension(60, 0));
        TableAlumno.setPreferredSize(new java.awt.Dimension(300, 0));
        TableAlumno.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TableAlumnoMouseClicked(evt);
            }
        });
        jScrollPane7.setViewportView(TableAlumno);
        TableAlumno.getAccessibleContext().setAccessibleDescription("");

        jPanel14.add(jScrollPane7, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 20, 530, 390));

        jPanel15.setBackground(new java.awt.Color(204, 204, 255));
        jPanel15.setPreferredSize(new java.awt.Dimension(280, 367));

        jLabel39.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/alum.png"))); // NOI18N
        ...
        jLabel44.setText("GRADO:");

        btnGuardarAlumno.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/GuardarTodo.png"))); // NOI18N
        btnGuardarAlumno.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        btnNuevoAlumno.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/nuevo.png"))); // NOI18N
        ...
        btnEliminarAlumno.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/eliminar.png"))); // NOI18N
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel15Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtIdAlumno, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel15Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel15Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtnomalu, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel15Layout.createSequentialGroup()
                                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel14.add(jPanel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 280, 380));
    ...
    private void btnEditarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarClienteActionPerformed
        ...
        if ("".equals(txtIdCliente.getText())) {
            ...
            if (!"".equals(txtDniCliente.getText()) || !"".equals(txtNombreCliente.getText()) || !"".equals(txtSexoCliente.getText())) {
                ...
                cl.setTelefono(txtSexoCliente.getText());
                cl.setDireccion(txtGradoCliente.getText());
    ...
    private void txtRucVentaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtRucVentaKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (!"".equals(txtRucVenta.getText())) {
                ...
                al = alum.Buscaralumno(ced);
                if (al.getNombre() != null) {
                    txtNombreClienteventa.setText("" + al.getNombre()+", " + al.getApellido());
                    txtIdCV.setText("" + al.getId());
                } else {
                    txtRucVenta.setText("");
    ...
    private void btnGuardarAlumnoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarAlumnoActionPerformed
        // TODO add your handling code here:
         if (!"".equals(txtnomalu.getText()) || !"".equals(txtapellidoalu.getText()) || !"".equals(txtCedula.getText()) || !"".equals(txtsexo.getText())|| !"".equals(txtgrado.getText())) {
            al.setNombre(txtnomalu.getText());
            al.setApellido(txtapellidoalu.getText());
            al.setCedula(txtCedula.getText());
            al.setSexo(txtsexo.getText());
            al.setGrado(txtgrado.getText());
            alum.RegistrarAlumnos(al);
    ...
    private void btnEditarAlumnoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarAlumnoActionPerformed
        // TODO add your handling code here:
         if ("".equals(txtIdAlumno.getText())) {
            JOptionPane.showMessageDialog(null, "seleccione una fila");
        } else {

            if (!"".equals(txtnomalu.getText()) || !"".equals(txtapellidoalu.getText()) || !"".equals(txtCedula.getText())) {
                al.setNombre(txtnomalu.getText());
                al.setApellido(txtapellidoalu.getText());
                al.setCedula(txtCedula.getText());
                al.setSexo(txtsexo.getText());
                al.setGrado(txtgrado.getText());
                alum.ModificarAlumnos(al);
    ...
    private void TableAlumnoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableAlumnoMouseClicked
        ...
        txtIdAlumno.setText(TableCliente.getValueAt(fila, 0).toString());
        txtnomalu.setText(TableCliente.getValueAt(fila, 1).toString());
        txtapellidoalu.setText(TableCliente.getValueAt(fila, 2).toString());
        txtCedula.setText(TableCliente.getValueAt(fila, 3).toString());
        txtsexo.setText(TableCliente.getValueAt(fila, 4).toString());
        txtgrado.setText(TableCliente.getValueAt(fila, 4).toString());
