...
public class VentaDao {
    ...
    public void pdfV(int idventa, int Cliente, double total, String fechav, String usuario, String observacion) {
        try {
            ...
            doc.open();
            Image img = Image.getInstance(getClass().getResource("/Img/logo-nuevo.jpg"));
            //Fecha
            ...
            float[] columnWidthsCliente = new float[]{50f, 25f, 25f,25f};
            ...
            PdfPCell cliSexo = new PdfPCell(new Phrase("Sexo", negrita));
            PdfPCell cliGrado = new PdfPCell(new Phrase("Grado", negrita));
            cliNom.setBorder(Rectangle.NO_BORDER);
            cliCedu.setBorder(Rectangle.NO_BORDER);
            cliSexo.setBorder(Rectangle.NO_BORDER);
            cliGrado.setBorder(Rectangle.NO_BORDER);
            proveedor.addCell(cliNom);
            proveedor.addCell( cliCedu);
            proveedor.addCell(cliSexo);
            proveedor.addCell(cliGrado);
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    proveedor.addCell(rs.getString("sexo"));
                    proveedor.addCell(rs.getString("grado") + "\n");
                } else {
